class MenusController < ApplicationController
  ...
  def create 
      ...
      begin 
        ...
        @customer = Customer.find(@menu.customer_id)
        @restaurant_system = RestaurantSystem.find(@customer.restaurant_system_id)
   	    if @menu.save 
  ...
  def menu_params
    params.require(:menu).permit(:dish_name, :dish_description, :dish_price, :customer_id )
  end
end
