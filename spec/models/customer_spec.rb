...
RSpec.describe Customer, type: :model do
  ...
  context 'assosiation test' do
    ...
    it 'should has many menus' do
      customerVar = FactoryGirl.create(:customer)
      menu1 = FactoryGirl.create(:menu, customer_id:customerVar.id)
      menu2 = FactoryGirl.create(:menu, customer_id:customerVar.id)
      menu1.customer_id.should eq customerVar.id
      menu2.customer_id.should eq customerVar.id
    end
    ...
    it 'should not has unincluded menus' do
      customerVar1 = FactoryGirl.create(:customer)
      customerVar2 = FactoryGirl.create(:customer)
      menu1 = FactoryGirl.create(:menu, customer_id:customerVar1.id)
      menu2 = FactoryGirl.create(:menu, customer_id:customerVar2.id)
      menu1.customer_id.should eq customerVar1.id
      menu1.customer_id.should_not eq customerVar2.id
      menu2.customer_id.should eq customerVar2.id
      menu2.customer_id.should_not eq customerVar1.id
    end
